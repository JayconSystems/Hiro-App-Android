...
public class Utils {
	...
	public final static String ACTION_WIFI_CHANGE = "ACTION_WIFI_CHANGE";
	public final static String ACTION_WIFI_RSSI_CHANGE = "ACTION_WIFI_RSSI_CHANGE";
	...
	public static IntentFilter makeIntentFilter() {
		...
		filter.addAction(ACTION_WIFI_RSSI_CHANGE);
	...
	public static void generateNotification(Context context, String title,
			String msg, int id, boolean isDisSound) {
